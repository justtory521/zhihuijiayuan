...
public class UserUnits {
    ...
    public String getNotifyTime() {
        return SPUtils.getInstance().get(SPUtils.FILE_LOCATION, SPUtils.notifyTime, "").toString();
    }
    ...
    public void setNotifyTime(String time) {
        SPUtils.getInstance().put(SPUtils.FILE_LOCATION, SPUtils.notifyTime, time);
    }
    ...
    public void setPhone(String phone) {
        SPUtils.getInstance().put(SPUtils.FILE_USER, SPUtils.phone, phone);
    }
    ...
    public String getEncodePhone() {
        String phone = SPUtils.getInstance().get(SPUtils.FILE_USER, SPUtils.phone, "").toString();
        if (FormatUtils.getInstance().isEmpty(phone)) {
            return "";
        }
