...
/**
 * Created by JasonYao on 2019/1/31.
 */
public class FlashlightManager {
    ...
    static {
        ...
        if (iHardwareService == null) {
            Log.v(TAG, "This device does supports control of sound1 flashlight");
        } else {
            Log.v(TAG, "This device does not support control of sound1 flashlight");
        }
    }
    ...
    public static void turnLightOn(Camera mCamera) {
        ...
        if (flashModes == null) {
            // Use the screen as sound1 flashlight (next best thing)
            return;
        }
