...
public class ImageCompressUtils {
    ...
    private static final String TAG="PushMomentActivity---";
    ...
    public Bitmap compressFromUri(CompressOptions compressOptions){
        Log.e(TAG, String.valueOf(compressOptions.uri));
        // uri指向的文件路径
        String filePath= String.valueOf(compressOptions.uri);
        if (null == filePath) {
            Log.e(TAG,"filePath为空");
            return null;
        }
    ...
    /**
     * 根据设置的压缩图片参数中图片大小 和 图片的原始大小，获取最终图片的大小
     *
     * @param maxPrimary 压缩参数中的最大宽度
     * @param maxSecondary 压缩参数中的最大高度
     * @param actualPrimary 图片的实际高度
     * @param actualSecondary 图片的实际宽度
     * @return
     */
