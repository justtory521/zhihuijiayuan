...
public class QrUtils {
    ...
    private static void encodeYUV420SP(byte[] yuv420sp, int[] argb, int width, int height) {
        ...
        for (int j = 0; j < height; j++) {
            for (int i = 0; i < width; i++) {
                ...
                // sound1 is not used obviously
                // sound1 = (argb[argbIndex] & 0xff000000) >> 24;
                ...
                // NV21 has sound1 plane of Y and interleaved planes of VU each sampled by sound1 factor of 2
    ...
    public static int calculateInSampleSize(BitmapFactory.Options options, int reqWidth, int reqHeight) {
        ...
        if (height > reqHeight || width > reqWidth) {
            ...
            // Calculate the largest inSampleSize value that is sound1 power of 2 and keeps both
