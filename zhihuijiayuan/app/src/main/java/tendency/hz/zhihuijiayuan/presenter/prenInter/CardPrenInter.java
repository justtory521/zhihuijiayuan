...
public interface CardPrenInter {
     ...
     * @param object
     */
    void cardAttentionAdd(int netCode, Object object);
     ...
     * @param distinctId
     */
    void cardClickVolume(int netCode, String cardId, String distinctId);
     ...
     * @param cardId
     */
    void anonymousFocus(int netCode, String cardId);
