...
-keep class [tendency.hz.zhihuijiayuan].** {*;}
-keep class tendency.hz.zhihuijiayuan.bean.**{*;}

-keep class tendency.hz.zhihuijiayuan.units.GsonUtils{*;}
...
-keep public class [tendency.hz.zhihuijiayuan].R$*{
    public static final int *;
}
-keepclassmembers class * {
   public <init> (org.json.JSONObject);
